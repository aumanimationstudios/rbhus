...
try:
  ...
  for proj in allProj:
    ...
    backup_cmd = "rsync -avzHXWhPs \'{0}\' --exclude=.hg* --exclude=.thumbz.db --exclude=output /aumbackup/backup1/".format(proj_dir+os.sep+proj['projName'])
    print(backup_cmd)
