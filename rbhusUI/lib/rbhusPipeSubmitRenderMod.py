...
class Ui_rbhusSubmit(object):
  def setupUi(self, rbhusSubmit):
    ...
    self.checkPngMov = QtGui.QCheckBox(self.centralwidget)
    self.checkPngMov.setChecked(False)
    self.checkPngMov.setObjectName(_fromUtf8("checkPngMov"))
    ...
    self.checkOutDir = QtGui.QCheckBox(self.centralwidget)
    self.checkOutDir.setText(_fromUtf8(""))
    self.checkOutDir.setObjectName(_fromUtf8("checkOutDir"))
  ...
  def retranslateUi(self, rbhusSubmit):
    ...
    self.checkPngMov.setText(_translate("rbhusSubmit", "convert png to MOV", None))
    ...
    self.checkHold.setToolTip(_translate("rbhusSubmit", "Submit , but put the task on hold", None))
