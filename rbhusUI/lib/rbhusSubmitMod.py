...
class Ui_rbhusSubmit(object):
  def setupUi(self, rbhusSubmit):
    ...
    self.gridLayout.addLayout(self.horizontalLayout_2, 24, 1, 1, 1)
    ...
    self.gridLayout.addWidget(self.pushSubmit, 24, 2, 1, 1)
    ...
    self.gridLayout.addWidget(self.lineEditHostGroups, 9, 1, 1, 1)
    ...
    self.gridLayout.addWidget(self.pushSelectHostGroups, 9, 2, 1, 1)
