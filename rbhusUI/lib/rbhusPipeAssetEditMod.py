...
class Ui_MainWindow(object):
  def setupUi(self, MainWindow):
    ...
    self.pushReviewNotifiers = QtGui.QPushButton(self.centralwidget)
    ...
    self.checkReviewNotifiers = QtGui.QCheckBox(self.centralwidget)
