...
#
# Created: Fri Oct 16 17:21:09 2015
...
class Ui_MainWindow(object):
  def setupUi(self, MainWindow):
    ...
    self.gridLayout.addWidget(self.checkVersion, 12, 1, 1, 1)
    self.pushEdit = QtGui.QPushButton(self.centralwidget)
    self.pushEdit.setObjectName(_fromUtf8("pushEdit"))
    self.gridLayout.addWidget(self.pushEdit, 15, 0, 1, 7)
    ...
    self.gridLayout.addWidget(self.line, 14, 0, 1, 7)
    ...
    self.gridLayout.addWidget(self.lineEditTags, 11, 1, 1, 4)
    ...
    self.gridLayout.addWidget(self.checkDesc, 8, 6, 1, 1)
    ...
    self.gridLayout.addWidget(self.checkTags, 11, 5, 1, 1)
    ...
    self.gridLayout.addWidget(self.checkVersionEnable, 12, 2, 1, 1)
    ...
    self.gridLayout.addWidget(self.lineEditReviewers, 7, 1, 1, 3)
    ...
    self.gridLayout.addWidget(self.checkReview, 7, 4, 1, 1)
