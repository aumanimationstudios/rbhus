...
#
# Created: Wed May 21 15:23:18 2014
...
class Ui_MainWindow(object):
  def setupUi(self, MainWindow):
    ...
    self.gridLayout.addItem(spacerItem, 9, 1, 1, 5)
    ...
    self.gridLayout.addWidget(self.line, 8, 0, 1, 8)
    ...
    item = QtGui.QListWidgetItem()
    self.listWidget.addItem(item)
    self.gridLayout.addWidget(self.listWidget, 7, 0, 1, 8)
    ...
    self.gridLayout.addWidget(self.assRefresh, 9, 7, 1, 1)
    ...
    self.gridLayout.addLayout(self.horizontalLayout, 4, 0, 1, 8)
    ...
    self.gridLayout.addWidget(self.pushLogout, 9, 0, 1, 1)
    ...
    self.gridLayout.addWidget(self.checkRefresh, 9, 6, 1, 1)
