...
#
# Created: Sat Jun 27 15:19:51 2015
...
class Ui_MainWindow(object):
  def setupUi(self, MainWindow):
    ...
    self.gridLayout.addWidget(self.line_3, 1, 1, 1, 2)
    ...
    self.listWidgetSearch = QtGui.QListWidget(self.centralwidget)
    ...
    self.pushSearchFavReset = QtGui.QPushButton(self.centralwidget)
    sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Fixed)
    sizePolicy.setHorizontalStretch(0)
    sizePolicy.setVerticalStretch(0)
    ...
    self.gridLayout.addLayout(self.verticalLayout_5, 0, 1, 1, 2)
    ...
    self.listWidgetAssets = QtGui.QListWidget(self.centralwidget)
    ...
    self.pushAssetFavReset = QtGui.QPushButton(self.centralwidget)
    sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Fixed)
    sizePolicy.setHorizontalStretch(0)
    sizePolicy.setVerticalStretch(0)
    ...
    self.gridLayout.addLayout(self.horizontalLayout_6, 3, 0, 2, 3)
  ...
  def retranslateUi(self, MainWindow):
    ...
    __sortingEnabled = self.listWidgetSearch.isSortingEnabled()
    self.listWidgetSearch.setSortingEnabled(False)
    item = self.listWidgetSearch.item(0)
    item.setText(_translate("MainWindow", "sdf", None))
    item = self.listWidgetSearch.item(1)
    item.setText(_translate("MainWindow", "sdf", None))
    item = self.listWidgetSearch.item(2)
    item.setText(_translate("MainWindow", "sd", None))
    item = self.listWidgetSearch.item(3)
    item.setText(_translate("MainWindow", "fs", None))
    item = self.listWidgetSearch.item(4)
    item.setText(_translate("MainWindow", "New Item", None))
    self.listWidgetSearch.setSortingEnabled(__sortingEnabled)
    self.tableWidget.setSortingEnabled(True)
    self.label_3.setText(_translate("MainWindow", "favourite", None))
    __sortingEnabled = self.listWidgetAssets.isSortingEnabled()
    self.listWidgetAssets.setSortingEnabled(False)
    item = self.listWidgetAssets.item(0)
    item.setText(_translate("MainWindow", "sdfs", None))
    item = self.listWidgetAssets.item(1)
    item.setText(_translate("MainWindow", "df", None))
    item = self.listWidgetAssets.item(2)
    item.setText(_translate("MainWindow", "sdf", None))
    item = self.listWidgetAssets.item(3)
    item.setText(_translate("MainWindow", "sdf", None))
    item = self.listWidgetAssets.item(4)
    item.setText(_translate("MainWindow", "sf", None))
    item = self.listWidgetAssets.item(5)
    item.setText(_translate("MainWindow", "a", None))
    item = self.listWidgetAssets.item(6)
    item.setText(_translate("MainWindow", "f", None))
    self.listWidgetAssets.setSortingEnabled(__sortingEnabled)
