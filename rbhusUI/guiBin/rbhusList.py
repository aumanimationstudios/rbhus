        ...
        if(fila):
          for fi in fila:
            if(sys.platform.find("win") >= 0):
              ...
              print("djv_view -file_proxy 1/4 "+ str(fi) +" -seq Off  -file_cache true")
              subprocess.Popen(["djv_view",str(fi),"-seq","Range","-file_cache","true"])
            print(fi)
      ...
      if(fila):
        ...
        for fi in fila:
          if(sys.platform.find("win") >= 0):
            ...
            subprocess.Popen(["djv_view",str(fi),"-seq","Off","-file_cache","true"])
          print(fi)
